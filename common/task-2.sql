...
INSERT INTO employees VALUES (130, 'Mozhe' , 'Atkinson' , 'MATKINSO' , '650.124.6234' , '1997-10-12' , 'ST_CLERK' , 2800 , NULL , 121 , 110);
 ...
 SELECT salary from employees ORDER BY salary DESC LIMIT 2 OFFSET 2;
 ...
 FROM employees where manager_id <=150
 GROUP BY manager_id
 ...
 SELECT * FROM  employees WHERE hire_date like '1994-08-17';
